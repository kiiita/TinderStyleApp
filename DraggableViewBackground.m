...
static const float CARD_WIDTH = 260; //%%% width of the draggable card
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setupView];
        exampleCardLabels = [[NSArray alloc]initWithObjects:@"Swipe",@"したり",@"ボタンを",@"おしたり",@"できるよ", nil]; //%%% placeholder for card-specific information
